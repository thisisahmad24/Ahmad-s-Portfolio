...
const professionalProjects = [
  {
    id: 1,
    title: "VIRQA — AI-Powered Interview & Assessment Platform",
    description:
      "AI-driven candidate evaluation system with structured workflows. Focus on AI-powered hiring systems. In active development.",
  ...
  {
    id: 2,
    title: "Agentic AI System (Multi-Agent Workflows)",
    description:
      "In Progress: An intelligent system utilizing multi-agent AI workflows for autonomous task execution.",
  ...
  },
  {
    ...
    description:
      "In Progress: Video comprehension and analysis utilizing computer vision while ensuring data privacy.",
  ...
  {
    id: 4,
    title: "Personal Portfolio (MERN)",
    description:
      "Built a responsive personal portfolio site to highlight technical and creative skills.",
    tech: ["React", "Node.js", "Express", "MongoDB", "Tailwind CSS"],
    github: "https://github.com/thisisahmad24/portfolio",
